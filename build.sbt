...
lazy val root = (project in file(".")).
  settings(
    ...
    resolvers ++= Seq (
      ...
      "io.confluent" % "timestamp-interceptor" % "7.4.1",
      ...
      excludeDependencies ++= Seq(
        ExclusionRule("io.confluent.observability", "telemetry-api"),
        ExclusionRule("io.confluent.observability", "telemetry-client")
    )
  )
